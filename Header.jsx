                        ...
                        <div className="w-full px-4 lg:w-5/12">
                            <div className="hero-content">
                                <h1 className="mb-5 text-4xl font-bold !leading-[1.208] text-dark dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl">
                                    Prezent Whats Happening Now
                                </h1>
                                <p className="mb-8 max-w-[480px] text-base text-body-color dark:text-dark-6">
                                    Our focus is no facilitating real-time connections and creating
                                    a supportive environment for continuous learning and growth.
                                </p>
                        ...
                        <div>
                            ...
                            >
                                <ul className="block lg:flex">
                                    <ListItem NavLink="/past">Past</ListItem>
                                    <ListItem NavLink="/present">Present</ListItem>
                                </ul>
                            </nav>
                        </div>
