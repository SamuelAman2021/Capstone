        ...
        <div className="flex w-full items-center justify-between px-">
          ...
          <div className="relative flex items-center justify-between">
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              ...
              <a
                href="/#"
                className="rounded-md bg-primary px-7 py-3 text-base font-medium text-white  bg-slate-900 hover:bg-primary/90"
              >
                Sign Up
              </a>
            </div>
  ...
  return (
    <>
      <li>
        <a
          href={NavLink}
          className="flex py-2 text-base font-medium text-body-color hover:text-dark dark:text-dark-6 dark:hover:text-white lg:mr-12 lg:inline-flex"
        >
          {children}
        </a>
      </li>
